...
function createHTMLElem(datestring) {
...
function sendToServer() {
    return __awaiter(this, void 0, void 0, function () {
        var date, serverresponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    date = JSON.stringify(dateelem.value);
                    return [4 /*yield*/, requestTextWithGET("http://localhost:3000/convertDate?date=" + date)];
                case 1:
